...
//   document.querySelectorAll('.jss-add-to-cart').forEach((button)=>{
...
//             itemsCount=itemsCount+itemIncart.quantity
//         });
//         document.querySelector('.js-cart-number').innerHTML=itemsCount;

//         console.log(itemsCount);
//         console.log(cart);

//         // setInterval(() => {
//         //     const modifyingStyle = document.createElement('style');
//         // modifyingStyle.textContent=`
//         //          .added-to-cart {
//         //             color: rgb(6, 125, 98);
//         //             font-size: 16px;
//         //             display: flex;
...
//         //         document.body.appendChild(modifyingStyle);
//         // }, 1000);
...
//             document.querySelector('.js-add-to-cart').style.opacity='1';
//         }
//        displayMessage();
